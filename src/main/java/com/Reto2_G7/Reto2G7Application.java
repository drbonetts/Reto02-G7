...
import com.Reto2_G7.repository.crud.UserCrudRepository;
...
public class Reto2G7Application implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(Reto2G7Application.class, args);
    }
